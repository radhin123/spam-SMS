...
def cok():
	while True:
		try:
			...
			asu=a[0:2]
			if a in(""," "):print("[!] Jangan Kosong NGENTOT")
			elif "08" not in asu:print("[!] Gunakan Nomer 08xxx\n")
			elif len(a)<=10:print("[!] Nomer Harus Lebih Dari 10 Angka jancok")
			elif a=="083870396203":print("[!] Anda Tidak Bisa Spam Yang Punya Script kontol!\n")
			else:
				try:
